...
<script>
    ...
    import {ThumbsUp, Heart,
        MessageCircle, Share2, Send, Image, Video, Calendar, FileText,
        BrainCircuit, Briefcase, Search, Home, Users, Bookmark } from 'lucide-svelte';

    // State variables
    // let isOpen = false;
    let messages = [
        { id: 1, text: "Hello! I'm your professional assistant. How can I help you today?", sender: 'bot', liked: false, disliked: false }
    ];
    // let inputValue = '';
    ...
    let posts = [
        {
            ...
            timeAgo: '2h',
            content: "Just finished the redesign for our client's e-commerce platform. Increased conversion rates by 24% through improved navigation and checkout flow. #UXDesign #ConversionOptimization",
        ...
        },
        {
            ...
            timeAgo: '5h',
            content: "We're excited to announce our new AI-powered chatbot integration platform that helps businesses improve customer engagement and support. Join our webinar next week to learn how it can transform your customer experience! #AI #CustomerExperience",
            likes: 243,
            comments: 28,
            shares: 42,
            isLiked: false
        },
        {
            ...
            timeAgo: '1d',
            content: "Just completed the React & Firebase masterclass. Here's my capstone project - a real-time collaboration tool with embedded AI assistant. Always looking to connect with other developers interested in similar technologies! #ReactJS #WebDev",
    ...
    <header class="bg-white border-b sticky top-0 z-10">
        <div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-16">
            <div class="flex items-center">
                <div class="text-blue-700 font-bold text-3xl mr-8">De-Linked</div>
                <div class="relative">
                    <input
                            type="text"
                            placeholder="Search"
                            class="bg-gray-100 p-2 pl-10 rounded-md w-64"
                    />
    ...
    <main class="max-w-6xl mx-auto px-4 py-6 flex">
        ...
        <div class="w-1/4 pr-4">
            <div class="bg-white rounded-lg shadow mb-4 overflow-hidden">
                ...
                <div class="p-4 relative">
                    <div class="h-16 w-16 rounded-full bg-gray-300 border-2 border-white absolute -top-8 left-4"></div>
                    <div class="mt-10">
        ...
        <div class="w-2/4 px-4">
            ...
            <div class="bg-white rounded-lg shadow mb-4 p-4">
                <div class="flex">
                    <div class="h-12 w-12 rounded-full bg-gray-300 mr-3"></div>
                    <input
                            type="text"
        ...
        <div class="w-1/4 pl-4">
            <div class="bg-white rounded-lg shadow p-4 mb-4">
                ...
                <a href="#" class="text-gray-500 text-sm flex items-center mt-1">
                    Show more
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <ul>
                    <li class="flex mb-4">
                        <img src="/api/placeholder/50/50" alt="" class="h-12 w-12 rounded-full mr-3" />
                        <div class="flex-1 text-sm">
                            <h3 class="font-medium">David Park</h3>
                            <p class="text-gray-500 text-xs">UX Researcher at DesignLab</p>
                            <button class="border border-gray-500 text-gray-500 rounded-full px-3 py-1 mt-2 hover:bg-gray-100 flex items-center">
