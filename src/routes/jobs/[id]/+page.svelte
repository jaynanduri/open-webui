	...
	<header class="bg-white border-b sticky top-0 z-10">
		<div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-16">
			...
			<nav class="flex items-center space-x-6">
				...
				<a href="#" class="flex flex-col items-center text-gray-500 hover:text-black">
					<Briefcase class="text-blue-700" size={20} />
					<span class="text-blue-700 text-xs mt-1">Jobs</span>
				</a>
						...
						<div class="p-6">
							...
							<div class="flex flex-wrap gap-y-2 text-sm text-gray-600 mb-4">
								<div class="flex items-center mr-4">
									...
									<span
										>{jobData.location || 'Location'}{jobData.remote_allowed
											? ' (Remote)'
											: ''}</span
									>
								</div>
					...
					<div class="md:w-80">
						...
						<div class="bg-white rounded-lg shadow p-4 mb-4">
							<h3 class="font-medium text-lg mb-3">
								About {jobData.company_name || 'the company'}
							</h3>
