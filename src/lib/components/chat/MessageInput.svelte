			...
			>
				<div class="">
					...
					{:else}
						...
						>
							<div
								class="flex-1 flex flex-col relative w-full rounded-3xl border border-gray-100 dark:border-gray-850 hover:border-gray-200 focus-within:border-gray-200 hover:dark:border-gray-800 focus-within:dark:border-gray-800 transition px-1 bg-white/90 dark:bg-gray-400/5 dark:text-gray-100"
							...
							>
								...
								<div class=" flex justify-between mt-1.5 mb-1.5 mx-0.5 max-w-full" dir="ltr"></div>
							</div>
						</form>
					{/if}
				</div>
